# Generated by Django 3.1.6 on 2021-04-12 21:20
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', models.CharField(choices=[('state1', 'state1'), ('state2', 'state2'), ('state3', 'state3'), ('state4', 'state4'), ('state5', 'state5'), ('state6', 'state6'), ('state7', 'state7'), ('state8', 'state8')], max_length=50)),
