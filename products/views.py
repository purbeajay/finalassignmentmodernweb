...
def show_cart(request):
    ...
    if request.user.is_authenticated:
        ...
        if cart_product:
            ...
            return render(request, 'product/emptycart.html', {'totalitem': totalitem})
    else:
        return render(request, 'product/emptycart.html', {'totalitem': totalitem})
...
def checkout(request):
    ...
    return render(request, 'product/checkout.html', {'add': add, 'cart_items': cart_items})
...
def address(request):
    ...
    return render(request, 'product/address.html', {'add': add, 'active': 'btn-primary', 'totalitem': totalitem})


@login_required
def orders(request):
    op = OrderPlaced.objects.filter(user=request.user)
    return render(request, 'product/orders.html', {'order_placed': op})
...
def mobile(request, data=None):
    ...
    return render(request, 'product/mobile.html', {'mobiles': mobiles, 'totalitem': totalitem})
...
class ProfileView(View):
    def get(self, request):
        ...
        return render(request, 'product/profile.html', {'form': form, 'active': 'btn-primary', 'totalitem': totalitem})
    ...
    def post(self, request):
        ...
        if form.is_valid():
            ...
            reg = Customer(user=usr, name=name, district=district, city=city, state=state, zipcode=zipcode)
            reg.save()
